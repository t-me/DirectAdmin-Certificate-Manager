...
class Lescript
{
    ...
    public function signDomains(array $domains, $maindomain, $reuseCsr = false)
    {
        ...
        foreach ($domains as $domain) {
			...
			$subdir = str_replace($maindomain,'',$domain);
			if($subdir == 'www.' || $subdir == ''){
				$subdir = '';
			}else{
				$subdir = '/'.str_replace('.','',$subdir);
			}
			
            $directory = $this->webRootDir . $subdir .'/.well-known/acme-challenge';
